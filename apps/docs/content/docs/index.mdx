...
<Callout title="Info">
For access to your access key and workspace ID, [sign up on our platform](https://dash.postiva.app/). You can create your access key via the panel once you're registered and locate your workspace ID in the account settings.
</Callout>
